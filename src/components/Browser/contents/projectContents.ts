...
export const ProjectContents = {
  cocktail: {
    ...
    lessonLearn: `혼자서 떠올리기 어려운 ui에 관한 아이디어를 접하고, 서로의 코드에 대한 개선점을 고민해보는 등 혼자서는 할 수 없는 협업에 대한 경험을 얻게 되었습니다.
      부족한 경험으로 능숙하게 팀프로젝트를 관리하지는 못했지만 이를 통해 일관성 있는 코드를 위한 팀 컨벤션이나, 효과적인 소통을 위해 근거를 기반으로 전달할 의견을 정리하는 것에 대한 중요성을 깨달았습니다.
