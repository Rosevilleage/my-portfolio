...
export const aboutContent = {
  name: "About Me",
  introduction: "지속적으로 성장하기 위해 노력하는 장찬희입니다.",
  background: [
    ...
    "회의나 코드 리뷰를 통해 다양한 의견을 듣는 것을 선호합니다. 국비지원 부트캠프의 현업종사자 멘토링에서 피드백에 대한 적극성이 좋다는 평가를 받았습니다.",
    "웹 뿐만 아니라 앱 개발에 도전하기 위해 react-native를 기반으로 식단 기록 애플리케이션인 mealmory 개발을 진행중에 있습니다.",
  ],
  contact: {
