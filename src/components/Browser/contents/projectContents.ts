...
export const aboutContent = {
  ...
  background: [
    ...
    "내가 몰랐던 것, 간과했던 것에 대해 고민해보고 공부하는 것에 적극적입니다.",
    "국비지원 부트캠프 교육중 두 번의 팀프로젝트에서 프론트엔드 팀장을 맡아 진행한 것을 토대로 백엔드 팀원과의 협업에 대해 이해하고 있습니다.",
    "회의나 코드 리뷰를 통해 다양한 의견을 듣는 것을 선호합니다. 현업자 멘토링 기간에 피드백에 대한 응답이 빠르고, 수용을 잘한다는 평가를 받았습니다.",
  ],
  contact: {
